...
var app_enews='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white "> News Paper  ( Daily Updated @ 07:00 AM)</div>'+
...
app_enews+='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white ">समाचार पत्र (दैनिक अद्यतन @ 07:00 पूर्वाह्न) </div>'+
'<!-- horizontal contdiner items start--->'+
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
...
app_enews+='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white ">Employment News weakly (SAT- FIR)</div>'+
'<!-- horizontal contdiner items start--->'+
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
...
app_enews+='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white ">Magzine</div>'+
'<!-- horizontal contdiner items start--->'+
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
...
app_enews+='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white ">Current Affairs</div>'+
'<!-- horizontal contdiner items start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
'<!-- horizontal contdiner start--->'+
