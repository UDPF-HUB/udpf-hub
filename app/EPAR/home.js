...
app_home+='<div class="w3-bar-items w3-padding w3-left w3-margin mycss-tr-gray-white "> हिन्दी समाचार पत्र </div>'+
'<!-- horizontal contdiner items start--->'+
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
...
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
'<div  onclick='+' udpf_link_finder2("file/d/","https://www.rojgarsmachar.in/rojgar-samachar-2022/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://www.rojgarsmachar.in/wp-content/uploads/Rojgar-Samachar-2022.jpg" alt="" width="100%" height="100px" loading="lazy"></br></br> English</div>'+
...
'<div  onclick='+' udpf_link_finder2("assets/pdf/kurukshetra","https://chahalacademy.com/free-downloads-kurukshetra")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://chahalacademy.com/images/currentaffairs/kurukshetra.jpg" alt="" width="100%" height="100px" loading="lazy"></br></br> Krukshetra Eng. </div>'+
'<div  onclick='+' udpf_link_finder2("assets/pdf/kurukshetra-hindi","https://chahalacademy.com/free-downloads-kurukshetra")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://chahalacademy.com/images/currentaffairs/kurukshetra.jpg" alt="" width="100%" height="100px" loading="lazy"></br></br> Kurukshetra Hindi</div>'+
...
'<div  onclick='+' udpf_link_finder2(".pdf","https://currentaffairs.adda247.com/current-affairs-oneliner-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://wpassets.adda247.com/wp-content/uploads/multisite/sites/5/2021/12/07100845/unnamed-1.png" alt="" width="100%" height="100px" loading="lazy"></br></br> Adda247</div>'+
...
'<div  onclick='+' udpf_link_finder2(".pdf","https://currentaffairs.adda247.com/monthly-current-affairs-pdf-2022/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://wpassets.adda247.com/wp-content/uploads/multisite/sites/5/2021/12/07100955/unnamed-2.png" alt="" width="100%" height="100px" loading="lazy"></br></br> Adda247</div>'+
