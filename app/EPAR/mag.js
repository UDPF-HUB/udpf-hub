...
'<div  onclick='+' udpf_link_finder2("ts/pdf/krukshetra","https://chahalacademy.com/free-downloads-kurukshetra")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://chahalacademy.com/images/currentaffairs/kurukshetra.jpg" alt="" width="100%" height="100px" loading="lazy"></br></br> Krukshetra Eng. </div>'+
'<div  onclick='+' udpf_link_finder2("assets/pdf/krukshetra-hindi","https://chahalacademy.com/free-downloads-kurukshetra")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;text-overflow:;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"> <img src="https://chahalacademy.com/images/currentaffairs/kurukshetra.jpg" alt="" width="100%" height="100px" loading="lazy"></br></br> Kurukshetra Hindi</div>'+
