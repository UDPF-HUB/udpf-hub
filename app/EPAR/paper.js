...
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/the-free-press-journal-epaper-download/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy">The Free Press....<p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
...
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/ekdin-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center ">Wkdin</p></div>'+
	'</div>'+
'<!-- horizontal contdiner end -->';
...
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/dinamani-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/dinakaran-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/dinamalar-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/daily-thanthi-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
	'</div>'+
'<!-- horizontal contdiner end -->';
...
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/andhra-bhoomi-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/vaartha-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/andhra-prabha-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/andhra-jyothi-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/eenadu-epaper-pdf-download-2020/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/nava-telangana-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/sakshi-epaper-pdf/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
	'</div>'+
'<!-- horizontal contdiner end -->';
...
'<!-- horizontal contdiner start--->'+
'<div class="mycss-horizontal-container" style="width:100%;">'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/inquilab-epaper/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
'<div  onclick='+' udpf_link_finder2("vk.com/doc",https://dailyepaper.in/siasat-daily-epaper/")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center "></p></div>'+
	'</div>'+
'<!-- horizontal contdiner end -->';
