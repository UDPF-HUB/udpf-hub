...
'<div  onclick='+' Website2APK.openExternal("https://aajkaal.in/images/nabc.pdf")'+' style="width:32.333333333%;height:180px; margin-bottom:2px;margin-right:2px;" class="w3-bar-items  w3-padding mycss-slide mycss-tr-gray-white w3-center"><img src="https://instaoffline.net/assets/img/folder.png" alt="" width="100%" height="100px" loading="lazy"><p style=" overflow-wrap: break-word; " class="w3-center ">Aajkaal</p></div>'+
